...
public class PullToRefreshListView extends PullToRefreshBase<ListView>
    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        if (!CommonUtility.Utility.isNull(attrs)) {
            ...
            mIsSection = array.getBoolean(
                    R.styleable.SectionListview_isSection, mIsSection);
            array.recycle();
        }
        if (mIsSection) {
            mListView = (ListView) LayoutInflater.from(context).inflate(
                    R.layout.view_section_listview, null);
        } else {
            mListView = (ListView) LayoutInflater.from(context).inflate(
    ...
    public void setScrollLoadEnabled(boolean scrollLoadEnabled) {
        ...
        //将这个footview remove
        if (!CommonUtility.Utility.isNull(mLoadMoreFooterLayout)) {
