package com.e.common.widget.popmenu;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
    ...
    public void setRootViewId(int id) {
        ...
        mItemContainer = (ViewGroup) mRootView.findViewById(R.id.effectLayout_item_container);
    ...
    public void addActionItem(ActionItem action) {
        ...
        container.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(QuickAction.this, pos, actionId,mData);
                }
        ...
        mItemContainer.addView(container, mChildPos);
...
//        int screenHeight 	= mWindowManager.getDefaultDisplay().getHeight();
        ...
        // display on bottom
        if (location[1]  < mContext.getResources().getDimensionPixelSize(R.dimen.size_dp_150)) {
            yPos = anchorRect.bottom;
            onTop = false;
        }

        showArrow(((onTop) ? R.id.arrow_down : R.id.arrow_up), (int) anchorRect.exactCenterX() - xPos);

        setAnimationStyle(screenWidth, anchorRect.centerX(), onTop);

        mWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, xPos, yPos);

        if (mAnimateTrack) mItemContainer.startAnimation(mTrackAnim);
    }
    ...
    public interface OnActionItemClickListener {
        public abstract void onItemClick(QuickAction source, int pos, int actionId,Bundle data);
    }
